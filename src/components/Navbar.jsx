  ...
  return (
    <nav className="fixed bottom-2 lg:bottom-8 w-full overflow-hidden z-50">
      <div className="container mx-auto px-4">
        {/* nav inner */}
        <div className="w-full bg-black/10 h-[70px] lg:h-[90px] backdrop-blur-3xl rounded-full max-w-[400px] lg:max-w-[460px] mx-auto px-4 lg:px-5 flex justify-between items-center text-xl lg:text-2xl text-white">
          <a href="#home">
