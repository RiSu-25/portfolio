...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "db95d245-0fe0-4ff3-aa4f-4a6eca35661c");
  ...
  return (
    <section id="contact" className="py-16 bg-gray-950 text-gray-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          className="flex flex-col lg:flex-row items-center gap-12 max-w-7xl mx-auto py-16"
          variants={variants}
          initial="initial"
          whileInView="animate"
        >
          {/* Text Container */}
          <motion.div
            className="flex-1 flex flex-col gap-8 text-white text-center lg:text-left"
            variants={variants}
          >
            <motion.h1
            ...
            <motion.div className="space-y-4" variants={variants}>
              ...
              <motion.div variants={variants} className="space-y-2">
                ...
                <span className="text-sm text-gray-300">+91 70243 98719</span>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          <div className="flex-1 relative z-10">
            ...
            >
              <svg
                ...
                className="stroke-orange-500 z-[-1] absolute bottom-0 left-0 right-0 mx-auto"
              >
                <motion.path
                  strokeWidth={0.2}
                  fill="none"
